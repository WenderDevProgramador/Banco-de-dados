-- CreateEnum
CREATE TYPE "LeadStatus" AS ENUM ('NEW', 'CONTACTED', 'QUALIFIED', 'CONVERTED', 'UNQUALIFIED', 'DISQUALIFIED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "LeadCampaignStatus" AS ENUM ('NEW', 'ENGAGED', 'FOLLoUp_SCHEDULEW', 'QUALIFIED', 'CONTACTED', 'CONVERTED', 'DISQUALIFIED', 'RE_ENGAGED', 'OPTED_OUT');
